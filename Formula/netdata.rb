class Netdata < Formula
  ...
  url "https://github.com/netdata/netdata/releases/download/v1.31.0/netdata-v1.31.0.tar.gz"
  sha256 "ca68f725224e8bbec041b493891376fbf41aedb47c4ac06161c2eda990089c9f"
